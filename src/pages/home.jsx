            ...
            {services.map((service, i) => {
              ...
              return (
                <div
                  key={serviceKey}
                  data-aos="zoom-in"
                  className="group bg-white rounded-2xl overflow-hidden hover:shadow-xl transition duration-300 flex flex-col justify-between border border-slate-100"
                >
                  <div>
                    {/* IMAGE */}
                    <Link
                    ...
                    <div className="p-6">
                      <Link
                        ...
                        className="block"
                      >
                        <h3 className="text-[#0872b9] text-xl font-semibold hover:text-[#f38020] transition-colors">
                          {service.title}
                        </h3>
                      </Link>
                  ...
                  <div className="p-6 pt-0">
                    <Link
                      to={detailsLink}
                      state={{ service: service.raw }}
                      className="text-[#f38020] font-medium text-sm hover:underline inline-flex items-center gap-1"
                    >
                      Learn More →
                    </Link>
                  </div>
